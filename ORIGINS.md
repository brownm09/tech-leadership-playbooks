...
| Framework | Engagement | Origin | Outcome | In my own words |
|---|---|---|---|---|
| [Career Ladder and Calibration Playbook](people/career-ladder-calibration.md) | ActBlue Technical Services (2022–2025) | Promotions for three engineers within three years; Engineering Management Community of Practice | Two SE2→SSE2 double promotions; one SSE→SSE2 promotion (five promotion events across the three engineers); CoP systematized talent development | "I drove promotions for three engineers within three years through deliberate project placement, calibration preparation, and sustained advocacy; two of the three were promoted twice each (SE2 to SSE2)." |
...
| Framework | Engagement | Origin | Outcome | In my own words |
|---|---|---|---|---|
| [Engineering Rhythm of Business](operating-cadence/engineering-rhythm-of-business.md) | ActBlue Technical Services (2024–2025) | Operating cadence design for ~20 engineers across 6 teams | Sustained delivery rhythm across the directorate; structured weekly/monthly/quarterly decision cadence | "I set and ran the operating cadence for the platform directorate as Senior Engineering Manager." |
...
| [LaunchDarkly Rollout Governance](experimentation/launchdarkly-rollout-governance.md) | ActBlue Technical Services (2022–2024) | End-to-end LaunchDarkly rollout: vendor relationship, proof-of-concept, cross-team adoption | First trivial flag in production within 4 months; first non-trivial customer-facing flag at 7 months; several teams adopted | "I managed the vendor relationship, designed the proof-of-concept, and drove cross-team adoption." |
| [Blameless Post-Mortem Framework](incident-management/blameless-postmortem-framework.md) | ActBlue Technical Services (2022–2025) | Post-mortem culture for high-availability payments infrastructure under PCI-DSS; SRE restructuring included post-mortem process redesign | Blameless analysis culture established; action item follow-through improved via ticket integration | "I owned post-mortem practice for the teams I managed within the platform directorate. The facilitation techniques and action item tracking approach here are what made the difference between post-mortems that changed things and those that didn't." |
